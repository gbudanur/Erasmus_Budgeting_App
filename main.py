...
def tutorial():
    print("--------")
    print("This app is designed to help you keep track of your money during your Erasmus mobility. You will be able to calculate your approximate monthly budget, see your savings and spendings from one place and plan your trips.")
    print("--------")
    print("Since this is your first time using the app, you will be asked to enter your duration of mobility, total savings and expected monthly income and spending. You will be able deposit and withdraw money and change the settings for monthly income and spending.")
    print("--------")
    print("Please note that, due to my inadequacy in both coding and economy, you are expected to start using this app in the beginning of a month to receive monthly budget expectations.")
    print("--------")
    print("However, you can still use the app to keep track of your spendings, at the end of each day, you can enter your spendings and the app will calculate your balance and save it for you. You can also deposit money at any time.")
    print("--------")
    print("Please visit 'History' page to access your balance history. You can also reset your data at any time from 'Settings' menu.")   
    print("--------")
    print("Final note: This app only accepts integer or float inputs. Please enter your values without any currency symbols.")
    return()

def soption1():
    print("--------")
    print("Enter the remaining duration of your mobility in months (Please change it every month) (0 to leave) Currently: "+db["str_duration"])
    print("--------")
...
def settings():
    print("--------")
    print("Settings: Duration of mobility (1), Tutorial (2), Reset data (3), Manual reset (4), Exit (0)")
    print("--------")
    option=1
    while option !="0":
        option=str(input(":"))
        ...
        if option == "1":
            ...
            deletext=1
            while deletext!="0":
                delete=input("Enter the name of the data you want to delete: format_name (float_mincome), type '0' to leave")
                if delete == "0":
                    deletext="0"
                else:
                    db[delete]=""
...
def withdraw():
    ...
    while withdrawamount != 0:
        print("--------")
        print("Withdraw: Enter the amount you would like to withdraw, type '0' to leave")
        print("--------")
...
def travelassist():
    ...
    print("--------")
    print("Please set a name for your trip or enter the trip you would like to access, type '0' to leave"+ " current trips: "+db["str_travels"])
    print("--------")
...
def budget():
    budgetbalance=(db["float_balance"]/float(db["str_duration"]))+db["float_mincome"]-db["float_mspending"]
    print("Monthly budget is: "+str(budgetbalance))
    

def main():
    print("--------------------")
    print("Choose an option: SETTINGS (1), DEPOSIT (2), WITHDRAW (3), MONTHLY INCOMES (4), MONTHLY SPENDINGS (5), BALANCE (6), HISTORY (7), TRAVEL PLANNING (8), EXIT (9)")
    print("--------------------")
    firstopt=str(input(":"))
    while firstopt != "1" and firstopt != "2" and firstopt != "3" and firstopt != "4" and firstopt != "5" and firstopt != "6" and firstopt != "7" and firstopt !="8" and firstopt !="9":
        print("--------")
        print("Please enter a valid number")
        print("--------")
        firstopt=str(input(":"))
...
if counter<1:
    print("--------")
    print("This is your first time using the app, type '1' to recevie the beginner's guide (highly recommended), type '0' to skip. Have an amazing Erasmus experince!")
